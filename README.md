...
**Примечание:** по совету Бориса Иомдина внесены небольшие изменения - помета "редко", в некоторых случаях встречавшаяся в колонке "word", теперь убрана в столбец "other".
