...
В основу словаря лег Самоучитель цыганского языка В.В. Шаповала\*. В рамках проекта часть Самоучителя была оцифрована и преобразована в таблицу формата .tsv, а также размечена согласно стандарту TEI и конвенциям, разработанным создателями проекта FreeDict (https://freedict.org/). Онлайн-версия словаря доступна по ссылке https://linghub.ru/RomaDict.
